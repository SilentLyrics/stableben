...
Original file is located at
    https://colab.research.google.com/drive/1MRxprxjFlOT7siEj5KJN6x03U8u-OLdi
...
data = pd.read_csv('minks-and-muskrats2.csv')

data.sample(6)

CHARACTER_NAME = 'Kasso#5421'
...
for step in range(4):
    ...
    print("stable ben: {}".format(tokenizer.decode(chat_history_ids[:, bot_input_ids.shape[-1]:][0], skip_special_tokens=True)))

"""## Push Model to Hugging Face"""

!sudo apt-get install git-lfs

!git config --global user.email "dennebav@gmail.com"
# Tip: using the same email as your huggingface.co account will link your commits to your profile
!git config --global user.name "SilentMyuth"

MY_MODEL_NAME = 'DialoGPT-large-stableben'
HUGGINGFACE_API_KEY = 'api_lyOrUCJnexwrgvxAXeykqrAAsbYQdOKqda'
